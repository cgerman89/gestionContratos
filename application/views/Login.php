...
<head>
    ...
    <link rel="stylesheet" href="<?php base_url();?>public/css/login_2.css">
...
<div  id="app_login">
     <div class="wrapper">
               <form id="form_session" role="form" class="form-signin bg-gray-light">
                   <div align="center">
                   ...
                   <button type="button" id="btn_session" name="btn_session"  @click="Valida" class="btn btn-lg btn-success btn-block"> <i class="fas fa-sign-in-alt"></i> &nbsp; Iniciar Session</button>
               </form>
